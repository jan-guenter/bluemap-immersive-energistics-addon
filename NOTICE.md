...
BlueMap Immersive Energistics Add-on is independently authored under MIT for the
...
backport commit `7e07f4e74ec1e92a6ead9aa1e66054af3e133aac`. BlueMap is not bundled.

The add-on compiles the four MIT-licensed production sources from the exact
